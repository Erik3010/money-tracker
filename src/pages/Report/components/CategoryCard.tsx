const CategoryCard = () => {
  return (
    <div className="rounded-lg border flex flex-col p-5 cursor-pointer hover:bg-gray-50">
      <div className="text-4xl w-16 h-16 flex items-center justify-center rounded-lg bg-blue-50/40 self-start">
        🍔
      </div>
